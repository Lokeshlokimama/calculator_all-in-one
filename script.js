...
const AI_TOOL_RULES = [
    ...
    { target: 'ai-tools-page', href: '/ai-tools/', label: 'AI Tools', category: 'web', keys: ['ai', 'ai tools', 'artificial intelligence', 'deepfake', 'synthetic media'], tip: 'Browse AI utilities with clear privacy and safety notes.' },
    { target: 'deepfake-checker-page', href: '/deepfake-checker/', label: 'AI Deepfake Checker', category: 'web', keys: ['deepfake checker', 'ai image checker', 'ai generated image', 'fake image', 'synthetic image', 'image authenticity'], tip: 'Check an image for probabilistic synthetic-media signals.' },
