...
const AI_TOOL_RULES = [
    ...
    { target: 'pdf-converter-page', href: '/pdf-converter/', label: 'PDF Converter', category: 'web', keys: ['pdf', 'pdf converter', 'pdf convertor', 'pdf to word', 'pdf to image', 'pdf pages', 'word document'], tip: 'Use it to convert PDFs to Word-compatible text files or page images.' },
    { target: 'images-to-pdf-page', href: '/images-to-pdf/', label: 'Images to PDF', category: 'web', keys: ['images to pdf', 'jpg to pdf', 'jpeg to pdf', 'png to pdf', 'webp to pdf', 'photo to pdf'], tip: 'Use it to turn JPG, PNG, or WebP images into one PDF.' },
    { target: 'merge-pdf-page', href: '/merge-pdf/', label: 'Merge PDF', category: 'web', keys: ['merge pdf', 'combine pdf', 'join pdf', 'multiple pdf into one'], tip: 'Use it to combine multiple PDFs into one file.' },
    { target: 'split-pdf-page', href: '/split-pdf/', label: 'Split PDF', category: 'web', keys: ['split pdf', 'extract pdf pages', 'pdf page range', 'separate pdf'], tip: 'Use it to extract selected pages from one PDF.' },
    { target: 'compress-pdf-page', href: '/compress-pdf/', label: 'Compress PDF', category: 'web', keys: ['compress pdf', 'reduce pdf size', 'smaller pdf', 'pdf size'], tip: 'Use it to create a smaller image-based PDF copy.' },
    { target: 'pdf-password-helper-page', href: '/pdf-password-helper/', label: 'PDF Password Helper', category: 'web', keys: ['pdf password', 'protect pdf', 'pdf lock', 'pdf encryption password'], tip: 'Use it to generate a strong password and safety note for PDF protection workflows.' },
    { target: 'ocr-scanned-pdf-page', href: '/ocr-scanned-pdf/', label: 'OCR Scanned PDF', category: 'web', keys: ['ocr pdf', 'scanned pdf text', 'extract text from scanned pdf', 'pdf ocr'], tip: 'Use it to extract plain text from scanned PDF pages.' },
